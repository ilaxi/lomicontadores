...
var archivo_guardado = "user://azquiely_enero.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Enero"]["Azquiely"] = SumaTM
...
func _on_button_d_pressed() -> void:
	var vamauri = "res://ESCENAS ENERO/ENEROMAURI.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(vamauri)
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS ENERO/ENEROMAURI.tscn"  
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS ENERO/ENEROWAL.tscn"
