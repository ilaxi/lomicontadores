...
var archivo_guardado = "user://franco_enero.json"
...
func guardar_suma():
	SumasGlobales.sumas_mensuales["Enero"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS ENERO/ENEROJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS ENERO/ENEROJOACO.tscn"  # Ruta a la escena deseada
