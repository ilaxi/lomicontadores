...
var archivo_guardado = "user://mauri_enero.json"
...
func guardar_suma():
	SumasGlobales.sumas_mensuales["Enero"]["Mauri"] = SumaTM
...
func _on_button_5_pressed() -> void:
	var vazqui = "res://ESCENAS ENERO/ENEROAZQUIELY.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(vazqui)
...
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS ENERO/ENEROAZQUIELY.tscn"
