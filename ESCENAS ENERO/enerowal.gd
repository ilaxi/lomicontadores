...
var archivo_guardado = "user://wal_enero.json"
...
func guardar_suma():
	SumasGlobales.sumas_mensuales["Enero"]["Wal"] = SumaTM
...
func _on_button_c_pressed() -> void:
	var vazquiely = "res://ESCENAS ENERO/ENEROAZQUIELY.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(vazquiely)


func _on_button_3_pressed() -> void:
	var vajoaco = "res://ESCENAS ENERO/ENEROJOACO.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(vajoaco)
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS ENERO/ENEROAZQUIELY.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS ENERO/ENEROJOACO.tscn"
