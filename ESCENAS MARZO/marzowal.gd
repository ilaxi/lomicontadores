...
var archivo_guardado = "user://wal_marzo.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Marzo"]["Wal"] = SumaTM
...
func _on_button_2_pressed() -> void:
	var vafranco = "res://ESCENAS MARZO/MARZOJOACO.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(vafranco)


func _on_button_a_pressed() -> void:
	var vawal = "res://ESCENAS MARZO/MARZOAZQUIELY.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS MARZO/MARZOAZQUIELY.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS MARZO/MARZOJOACO.tscn"
