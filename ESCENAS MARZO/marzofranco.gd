...
var archivo_guardado = "user://franco_marzo.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Marzo"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS MARZO/MARZOJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS MARZO/MARZOJOACO.tscn"  # Ruta a la escena deseada
