...
var archivo_guardado = "user://MAURI_marzo.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Marzo"]["Mauri"] = SumaTM
...
func _on_button_2_pressed() -> void:
	var vafranco = "res://ESCENAS MARZO/MARZOAZQUIELY.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS MARZO/MARZOAZQUIELY.tscn"
