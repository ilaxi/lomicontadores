...
var archivo_guardado = "user://joaco_febrero.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Febrero"]["Joaco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS FEBRERO/FEBREROWAL.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(nueva_escena)
	
	

func _on_button_4_pressed() -> void:
	var vafranco = "res://ESCENAS FEBRERO/FEBREROFRANCO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS FEBRERO/FEBREROWAL.tscn"  
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS FEBRERO/FEBREROFRANCO.tscn"
