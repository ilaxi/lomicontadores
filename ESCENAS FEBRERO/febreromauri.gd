...
var archivo_guardado = "user://mauri_febrero.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Febrero"]["Mauri"] = SumaTM
...
func _on_button_4_pressed() -> void:
	var vafranco = "res://ESCENAS FEBRERO/FEBREROAZQUIELY.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS FEBRERO/FEBREROAZQUIELY.tscn"
