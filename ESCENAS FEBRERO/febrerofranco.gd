...
var archivo_guardado = "user://franco_febrero.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Febrero"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS FEBRERO/FEBREROJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS FEBRERO/FEBREROJOACO.tscn"  # Ruta a la escena deseada
