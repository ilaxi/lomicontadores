...
var DiasSemana2 = [0, 0, 0, 0, 0, 0, 0] 
var DiasSemana3 = [0, 0, 0, 0, 0, 0, 0] 
...
var archivo_guardado = "user://wal_febrero.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Febrero"]["Wal"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS FEBRERO/FEBREROAZQUIELY.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(nueva_escena)
	
	

func _on_button_4_pressed() -> void:
	var vafranco = "res://ESCENAS FEBRERO/FEBREROJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS FEBRERO/FEBREROAZQUIELY.tscn"  
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS FEBRERO/FEBREROJOACO.tscn"
