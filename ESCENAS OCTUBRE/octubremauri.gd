...
var archivo_guardado = "user://mauri_OCTUBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Octubre"]["Mauri"] = SumaTM
...
func _on_button_2_pressed() -> void:
	var vafranco = "res://ESCENAS OCTUBRE/OCTUBREAZQUIELY.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS OCTUBRE/OCTUBREAZQUIELY.tscn"
