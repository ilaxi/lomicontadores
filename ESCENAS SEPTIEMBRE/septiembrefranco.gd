...
var archivo_guardado = "user://franco_SEPTIEMBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Septiembre"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS SEPTIEMBRE/SEPTIEMBREJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS SEPTIEMBRE/SEPTIEMBREJOACO.tscn"  # Ruta a la escena deseada
