...
var archivo_guardado = "user://franco_julio.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Julio"]["Franco"] = SumaTM
...
func cargar_datos():
	...
	# CARGAR LOS LINE EDIT CON EL NUMERO VISIBLE
	for dia_index in range(7):  #0,1,2,3,4,5,6
...
func _on_b_1_pressed() -> void:
	var SeleEscena = "res://ESCENASELECCIONARMES/SELECCIONARMES.tscn"  
...
func nodosBotones(NodoBoton):
	var NombreNodo = "Button"
	var NodoFleDer = NodoBoton.get_node(NombreNodo)
	NodoFleDer.connect("pressed", Callable(self, "_der_boton"))
	

func _der_boton():
	var EscenaDerecha = "res://ESCENAS JULIO/JULIOJOACO.tscn"
	get_tree().change_scene_to_file(EscenaDerecha)
	
	
	
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS JULIO/JULIOJOACO.tscn"  
