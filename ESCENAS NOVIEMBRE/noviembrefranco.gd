...
var archivo_guardado = "user://franco_NOVIEMBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Noviembre"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS NOVIEMBRE/NOVIEMBREJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS NOVIEMBRE/NOVIEMBREJOACO.tscn"  # Ruta a la escena deseada
