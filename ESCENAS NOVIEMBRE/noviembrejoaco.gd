...
var archivo_guardado = "user://joaco_NOVIEMBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Noviembre"]["Joaco"] = SumaTM
...
func _on_button_a_pressed() -> void:
	var nueva_escena = "res://ESCENAS NOVIEMBRE/NOVIEMBREWAL.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(nueva_escena)
	
	
func _on_button_2_pressed() -> void:
	var nuevaEscena = "res://ESCENAS NOVIEMBRE/NOVIEMBREFRANCO.tscn"
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS NOVIEMBRE/NOVIEMBREWAL.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS NOVIEMBRE/NOVIEMBREFRANCO.tscn"
