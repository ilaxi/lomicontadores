...
var archivo_guardado = "user://mauri_DICIEMBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumaDIC["Diciembre"]["Mauri"] = SumaTM
...
func _on_button_2_pressed() -> void:
	var vafranco = "res://ESCENAS DICIEMBRE/DICIEMBREAZQUIELY.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS DICIEMBRE/DICIEMBREAZQUIELY.tscn"
