...
var archivo_guardado = "user://franco_DICIEMBRE.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumaDIC["Diciembre"]["Franco"] = SumaTM
...
func _on_button_pressed() -> void:
	var nueva_escena = "res://ESCENAS DICIEMBRE/DICIEMBREJOACO.tscn"  # Ruta a la escena deseada
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS DICIEMBRE/DICIEMBREJOACO.tscn"  # Ruta a la escena deseada
