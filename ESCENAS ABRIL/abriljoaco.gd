...
var archivo_guardado = "user://joaco_abril.json"
...
func actualizar_totales():
		...
		guardar_suma()
func guardar_suma():
	SumasGlobales.sumas_mensuales["Abril"]["Joaco"] = SumaTM
...
func _on_button_a_pressed() -> void:
	var nueva_escena = "res://ESCENAS ABRIL/ABRILWAL.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(nueva_escena)
	
	
func _on_button_2_pressed() -> void:
	var nuevaEscena = "res://ESCENAS ABRIL/ABRILFRANCO.tscn"
...
func Cambiar_escenaDer():
	var QueEscena = "res://ESCENAS ABRIL/ABRILWAL.tscn"  # Ruta a la escena deseada
	get_tree().change_scene_to_file(QueEscena)
	
func Cambiar_escenaIzq():
	var OtraEscena = "res://ESCENAS ABRIL/ABRILFRANCO.tscn"
